...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str,
                        default='./data/dataset_test/input_full_test_50k_0.030/bed_0520.obj.xyz')
    parser.add_argument('--output', type=str, default='./bed_0520.denoised.xyz')
    parser.add_argument('--ckpt', type=str, default='./pretrained/unsupervised/epoch=141.ckpt')
    ...
    pcd = o3d.io.read_point_cloud('./airplane_0016.xyz')
